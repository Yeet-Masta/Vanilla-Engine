...
local shaders = {
    ...
    wiggleGround = {2, 4, 0.007, WIGGLE_SHADER_TYPE.DREAMY, shader = nil},
    wiggleTrees = {2, 4, 0.007, WIGGLE_SHADER_TYPE.DREAMY, shader = nil}
}
...
function Stage:build()
    ...
    get("backTrees").shader = shaders.wiggleBack.shader
    get("school").shader = shaders.wiggleSchool.shader
    get("street").shader = shaders.wiggleGround.shader
    get("trees").shader = shaders.wiggleTrees.shader
end
