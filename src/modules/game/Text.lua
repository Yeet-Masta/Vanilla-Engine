-- Repurposed from Mint Engine lol

local Text = Object:extend()

Text.alignment = "center"
Text.borderColor = hex2rgb(0x000000)
Text.borderSize = 1
Text.font = nil
Text.text = " " -- cant be empty
Text.color = hex2rgb(0xFFFFFFFF)
Text.alpha = 1
Text.camera = nil
Text.visible = true
Text.exists = true
...
function Text:new(x, y, limit, text, font)
    ...
    self.borderColor = hex2rgb(0x000000)
    self.font = font or love.graphics.getFont()
    self.text = text
    self.fullText = text -- for dialogue
    self.color = hex2rgb(0xFFFFFFFF)
    self.alpha = 1
    camera = nil
    self.visible = true
    self.exists = true
